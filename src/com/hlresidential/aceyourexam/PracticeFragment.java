...
public class PracticeFragment extends Fragment implements
	...
	public static final String PREF_LAST_SCREEN_TOREVIEW = "prefLastScreenReport";
	...
	ImageView iv_correct, iv_incorrect;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.practice_flip, container, false);
...
//L		Log.e(TAG, "setup FragmentTitle ... just started");
		...
		iv_correct = (ImageView) getView().findViewById(
				R.id.iv_correct);
		iv_incorrect = (ImageView) getView().findViewById(
				R.id.iv_incorrect);
...
//L		Log.e(TAG, "nextRow()");
	...
	public void rowOddOrEven() {
		...
		iv_incorrect.setVisibility(View.GONE);
		if (isOdd(cursor.getPosition())) { 
			oddRow();
		} else {
			evenRow();
...
//				+ " <id> "
	...
	private void onOddSubmitButton() {
		...
		switch (ioddCorrect) {
		case 1:
			Log.e(TAG, " (Od1) Left: " + rb_odd_answer1.getLeft() + " Top: " + rb_odd_answer1.getTop());


//			iv_correct.setLeft(rb_odd_answer1.getLeft()); iv_correct.setTop(rb_odd_answer1.getTop());
//			iv_correct.setVisibility(View.VISIBLE);
			rb_odd_answer1.setChecked(true); ignoreClick = true;
			rb_odd_answer1.setVisibility(View.VISIBLE);
			break;
		case 2:
			Log.e(TAG, " (Od2) Left: " + rb_odd_answer2.getLeft() + " Top: " + rb_odd_answer2.getTop());
			iv_correct.setLeft(rb_odd_answer2.getLeft()); iv_correct.setTop(rb_odd_answer2.getTop());
			iv_correct.setVisibility(View.VISIBLE);
			rb_odd_answer2.setChecked(true); ignoreClick = true;
			rb_odd_answer2.setVisibility(View.VISIBLE);
			break;
		case 3:
			Log.e(TAG, " (Od3) Left: " + rb_odd_answer3.getLeft() + " Top: " + rb_odd_answer3.getTop());
			iv_correct.setLeft(rb_odd_answer3.getLeft()); iv_correct.setTop(rb_odd_answer3.getTop());
			iv_correct.setVisibility(View.VISIBLE);
			rb_odd_answer3.setChecked(true); ignoreClick = true;
			rb_odd_answer3.setVisibility(View.VISIBLE);
			break;
		case 4:
			Log.e(TAG, " (Od4) Left: " + rb_odd_answer4.getLeft() + " Top: " + rb_odd_answer4.getTop());
			iv_correct.setLeft(rb_odd_answer4.getLeft()); iv_correct.setTop(rb_odd_answer4.getTop());
			iv_correct.setVisibility(View.VISIBLE);
		...
		if (ioddCorrect == ioddChosen) { 
			...
			switch (ioddChosen) {
			case 1:
				iv_incorrect.setLeft(rb_odd_answer1.getLeft()); iv_incorrect.setTop(rb_odd_answer1.getTop()); iv_incorrect.setVisibility(View.VISIBLE);
				rb_odd_answer1.setVisibility(View.VISIBLE);
				animX = ObjectAnimator.ofFloat(rb_odd_answer1, "translationX",
						fDistance);
				break;
			case 2:
				iv_incorrect.setLeft(rb_odd_answer2.getLeft()); iv_incorrect.setTop(rb_odd_answer2.getTop()); iv_incorrect.setVisibility(View.VISIBLE);
				rb_odd_answer2.setVisibility(View.VISIBLE);
				animX = ObjectAnimator.ofFloat(rb_odd_answer2, "translationX",
						fDistance);
				break;
			case 3:
				iv_incorrect.setLeft(rb_odd_answer3.getLeft()); iv_incorrect.setTop(rb_odd_answer3.getTop()); iv_incorrect.setVisibility(View.VISIBLE);
				rb_odd_answer3.setVisibility(View.VISIBLE);
				animX = ObjectAnimator.ofFloat(rb_odd_answer3, "translationX",
						fDistance);
				break;
			case 4:
				iv_incorrect.setLeft(rb_odd_answer4.getLeft()); iv_incorrect.setTop(rb_odd_answer4.getTop()); iv_incorrect.setVisibility(View.VISIBLE);
				rb_odd_answer4.setVisibility(View.VISIBLE);
	...
	private void onEvenSubmitButton() {
		...
		switch (ievenCorrect) {
		case 1:
			Log.e(TAG, " (E1) Left: " + rb_even_answer1.getLeft() + " Top: " + rb_even_answer1.getTop());
			iv_correct.setLeft(rb_even_answer1.getLeft()); iv_correct.setTop(rb_even_answer1.getTop());
			iv_correct.setVisibility(View.VISIBLE);
			rb_even_answer1.setChecked(true); ignoreClick = true;
			rb_even_answer1.setVisibility(View.VISIBLE);
			break;
		case 2:
			Log.e(TAG, " (E2) Left: " + rb_even_answer2.getLeft() + " Top: " + rb_even_answer2.getTop());
			iv_correct.setLeft(rb_even_answer2.getLeft()); iv_correct.setTop(rb_even_answer2.getTop());
			iv_correct.setVisibility(View.VISIBLE);
			rb_even_answer2.setChecked(true); ignoreClick = true;
			rb_even_answer2.setVisibility(View.VISIBLE);
			break;
		case 3:
			Log.e(TAG, " (E3) Left: " + rb_even_answer3.getLeft() + " Top: " + rb_even_answer3.getTop());
			iv_correct.setLeft(rb_even_answer3.getLeft()); iv_correct.setTop(rb_even_answer3.getTop());
			iv_correct.setVisibility(View.VISIBLE);
			rb_even_answer3.setChecked(true); ignoreClick = true;
			rb_even_answer3.setVisibility(View.VISIBLE);
			break;
		case 4:
			Log.e(TAG, " (E4) Left: " + rb_even_answer4.getLeft() + " Top: " + rb_even_answer4.getTop());
			iv_correct.setLeft(rb_even_answer4.getLeft()); iv_correct.setTop(rb_even_answer4.getTop());
			iv_correct.setVisibility(View.VISIBLE);
		...
		if (ievenCorrect == ievenChosen) {
			...
			switch (ievenChosen) {  
			case 1:
				iv_incorrect.setLeft(rb_even_answer1.getLeft()); iv_incorrect.setTop(rb_even_answer1.getTop());
				iv_incorrect.setVisibility(View.VISIBLE);
				rb_even_answer1.setVisibility(View.VISIBLE);
        ...
        public DrawView(Context context, AttributeSet attrs, int defStyle) {
	      ...
	      @Override
	        protected void onDraw(Canvas canvas) {
	            super.onDraw(canvas);
	            canvas.drawBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.correct), 40, 40, null);
